...
public:
  Colors() = default;
  Colors(const Qt::GlobalColor &c) : m_colors(TVectorType({{1.0f, c}})) {}
  Colors(const QColor &c) : m_colors(TVectorType({{1.0f, c}})) {}
  Colors(const std::initializer_list<Color> &c) : m_colors(TVectorType(c)) {}
  ...
  TVectorType::iterator begin() { return m_colors.begin(); }
  TVectorType::iterator end() { return m_colors.end(); }
  TVectorType::const_iterator begin() const { return m_colors.cbegin(); }
  TVectorType::const_iterator end() const { return m_colors.cend(); }
